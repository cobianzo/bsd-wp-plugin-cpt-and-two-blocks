...
describe(
	...
	function() {
		...
		it(
			"writes a 20MB file (autoClose on)",
			function(done) {
				fs.open(
					testOutBlobFile,
					'w',
		...
		it(
			"write stream does not emit error when max size not exceeded",
			function(done) {
				fs.open(
					testOutBlobFile,
					'w',
		...
		it(
			"write stream unrefs when destroyed",
			function(done) {
				fs.open(
					testOutBlobFile,
					'w',
		...
		it(
			"read stream unrefs when destroyed",
			function(done) {
				fs.open(
					testBlobFile,
					'r',
